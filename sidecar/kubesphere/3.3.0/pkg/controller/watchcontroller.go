...
func NewWatchController(r *ks.Runtime) pkg.Controller {
...
func (c *WatchController) Run(stopCh <-chan struct{}) {
...
func (c *WatchController) enqueue(obj interface{}) {
	c.workqueue.Add(obj)
}

func (c *WatchController) runWorker() {
...
func (c *WatchController) reconcile(_ interface{}) error {
